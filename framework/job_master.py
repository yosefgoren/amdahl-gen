...
class JobMaster:
    ...
    def satisfy(self, config: Config, amount_required: int = 1, exclude_results: set[ElementId] = set()) -> set[ElementId]:
        """
        ...
        """
        initial_matches: set[ElementId] = self.db.query(config)
